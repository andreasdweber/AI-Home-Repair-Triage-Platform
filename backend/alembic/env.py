"""
Alembic Environment Configuration for Fix-It AI
Dynamically loads DATABASE_URL from environment variables
"""
...
def run_migrations_online() -> None:
    ...
    # Create engine with the dynamic URL
