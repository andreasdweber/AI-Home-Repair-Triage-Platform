...
/**
 * TenantWidget - Chat-only widget for tenants to report maintenance issues
 * This is the embeddable widget for property websites
 */
        ...
        <div className="mb-3 w-80 sm:w-96 h-[32rem] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
          ...
          <div className="bg-blue-600 text-white flex-shrink-0">
            <div className="px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs bg-blue-500 px-2 py-0.5 rounded">Maintenance</span>
              </div>
          ...
          {requestPhoto && !file && (
            <div 
              ...
              className="px-3 py-2 bg-yellow-50 border-t border-yellow-200 flex items-center justify-between cursor-pointer hover:bg-yellow-100 transition"
            >
              <span className="text-xs text-yellow-700">📷 Tap to add a photo of the issue</span>
          ...
          <div className="p-3 border-t border-gray-200 bg-white flex-shrink-0">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => fileInputRef.current?.click()}
                className={`p-2 rounded-lg transition ${requestPhoto ? 'text-yellow-600 bg-yellow-50 hover:bg-yellow-100' : 'text-gray-500 hover:text-blue-600 hover:bg-blue-50'}`}
                title="Attach photo"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <input
                ...
                placeholder={awaitingConfirmation ? "Type 'yes' to confirm..." : "Describe the issue..."}
